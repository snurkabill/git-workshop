...
public class BasicRulesTester extends org.junit.Assert {
    ...
    /**
     * Test the visibility of attributes
    ...
    /**
     * Check that class has a static method with required signature
     * @param clazz tested class
    ...
    /**
     * Convenience method combining {@link  #testAttributes(Class)} and {@link #testMethods(Class)}
     * @param clazz tested class
     */
     ...
     * @param clazz tested class
     * @param name name of the tested method
     * @param paramTypes parameter types of the tested method
     */
    @SuppressWarnings("unchecked")
